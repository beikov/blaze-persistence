...
25/07/2026 - [Release tag](https://github.com/Blazebit/blaze-persistence/releases/tag/1.6.19) [Resolved issues](https://github.com/Blazebit/blaze-persistence/issues?q=is%3Aissue+milestone%3A1.6.19+is%3Aclosed+sort%3Aupdated-desc)

### New features

* Ensure support for Hibernate ORM 7.3 and 7.4
* Ensure support for Spring Boot/Data 4.1
...
03/09/2025 - [Release tag](https://github.com/Blazebit/blaze-persistence/releases/tag/1.6.17) [Resolved issues](https://github.com/Blazebit/blaze-persistence/issues?q=is%3Aissue+milestone%3A1.6.17+is%3Aclosed+sort%3Aupdated-desc)
